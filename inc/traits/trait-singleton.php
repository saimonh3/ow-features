...
namespace OW_Features\Features\Inc\Traits;
...
trait Singleton {
	...
	final public static function get_instance() {
		...
		if ( ! isset( $instance[ $called_class ] ) ) {
			...
			/**
			 * Dependent items can use the ow_features_features_singleton_init_{$called_class} hook to execute code
			 */
			do_action( sprintf( 'ow_features_features_singleton_init_%s', $called_class ) ); // phpcs:ignore WordPress.NamingConventions.ValidHookName.UseUnderscores
